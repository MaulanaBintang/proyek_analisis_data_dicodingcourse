...
days_data = pd.read_csv("dashboard/day.csv")
hours_data = pd.read_csv("dashboard/hour.csv")
...
sns.barplot(x="hours", y="count_cr", data=sum_order_items_data.head(5), palette=["#D3D3D3", "#D3D3D3", "#90CAF9", "#D3D3D3", "#D3D3D3"], ax=ax[0])
...
sns.barplot(x="hours", y="count_cr", data=sum_order_items_data.sort_values(by="hours", ascending=True).head(5), palette=["#D3D3D3", "#D3D3D3", "#D3D3D3", "#D3D3D3","#90CAF9"], ax=ax[1])
